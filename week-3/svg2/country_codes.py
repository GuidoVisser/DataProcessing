...
Programm that create a dictionary between three letter country codes and two letter country codes
"""
...
with open('CountryCodeMap.json', "w") as outfile:
    outfile.write(dumps(dict, outfile).encode('utf8'))